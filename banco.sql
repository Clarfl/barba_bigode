...
--
-- Host: localhost
-- Tempo de geração: 26/11/2023 às 16:14
...
INSERT INTO `filial` (`idFilial`, `descricao_F`, `localização`, `responsável`) VALUES
(1, 'opa', 'ilheus', 'eu'),
(2, 'legal', 'brasil', 'minha mae'),
(3, 'opa', 'ilheus', 'eu');
...
ALTER TABLE `atendimento`
  ...
  ADD CONSTRAINT `atendimento_ibfk_2` FOREIGN KEY (`idServico`) REFERENCES `servico` (`idServico`),
  ADD CONSTRAINT `atendimento_ibfk_3` FOREIGN KEY (`idServico`) REFERENCES `servico` (`idServico`),
  ADD CONSTRAINT `atendimento_ibfk_4` FOREIGN KEY (`idFilial`) REFERENCES `filial` (`idFilial`);
COMMIT;
